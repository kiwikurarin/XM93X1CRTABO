...
# ～ RevenueCat@me123
^https:\/\/api\.revenuecat\.com\/.+\/(receipts$|subscribers\/[^/]+$) url script-response-body https://raw.githubusercontent.com/me123/Module_IOS/refs/heads/main/js/revenuecat.js
^https:\/\/api\.revenuecat\.com\/.+\/(receipts|subscribers) url script-request-header https://raw.githubusercontent.com/me123/Module_IOS/refs/heads/main/js/deleteHeader.js
...
if (match) {
  ...
  if (product_id) {
    me12[_0x31b760(403, "XJf3")] = product_id;
    obj[_0x31b760(373, "^J8$")].subscriptions[product_id] = me123;
  } else {
    obj[_0x31b760(362, "JYeS")].subscriptions[_0x31b760(389, "XJf3")] = me123;
  }
  ...
  if (key[_0x31b760(384, "q3!$")]("&")) {
    ...
    parts[_0x31b760(386, "XJf3")](_0x563180 => {
      ...
      obj[_0x2d48ba(364, "!FyN")].entitlements[_0x563180] = me12;
    });
  } else {
    obj[_0x31b760(400, "Zger")][_0x31b760(379, "JPYr")][key] = me12;
  }
} else {
  obj[_0x31b760(385, "vGhG")][_0x31b760(363, "Z#v]")][_0x31b760(397, "mXiu")] = me123;
  obj.subscriber[_0x31b760(398, "JqZu")][_0x31b760(378, "ZpT*")] = me12;
}
